...
constexpr SDL_Color COLOR_WHITE            = { 0xfc, 0xfc, 0xfc, 0xff };
constexpr SDL_Color COLOR_BACKGROUND       = { 0x2d, 0x2d, 0x2d, 0xff };
constexpr SDL_Color COLOR_ALT_BACKGROUND   = { 0x32, 0x32, 0x32, 0xff };
constexpr SDL_Color COLOR_HIGHLIGHTED      = { 0x61, 0xd8, 0xe7, 0xff };
constexpr SDL_Color COLOR_TEXT             = { 0xd1, 0xd1, 0xd1, 0xff };
constexpr SDL_Color COLOR_ALT_TEXT         = { 0xb0, 0xb0, 0xb0, 0xff };
constexpr SDL_Color COLOR_ACCENT           = { 0x35, 0xd2, 0xae, 0xff };
constexpr SDL_Color COLOR_ALT_ACCENT       = { 0x1f, 0x22, 0x28, 0xff };
constexpr SDL_Color COLOR_BARS             = { 0x0d, 0x5e, 0x36, 0xff };
